...
- Sub-agent fleet limits — a new **Fleet** group in the new-session Advanced settings lets you cap how many layers of sub-agents can nest below the main agent, and how many can run at once, so a single prompt can't silently fan out further than you intend
