...
- Centre Ring — the house behind the beam now lights up seat by seat as a turn's prompt fills the model's context window, dimming again after a compaction, so you can see how full the conversation is getting without leaving the view
