...
- **Neural Pulse** — living organism canvas showing causal relationships between prompts, thinking, and tool calls as a radial tree, zoomable and pannable, with sub-agents as integrated branches
